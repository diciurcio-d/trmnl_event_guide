...
YTMUSIC_MAX_ARTISTS = 300         # Maximum artists to search for
...
NEWSLETTER_MODEL = "gemini-2.5-pro"      # Model used for newsletter event curation. Try "gemini-2.5-flash" or "gemini-2.5-flash-lite" for faster/cheaper.
NEWSLETTER_TIMEOUT_SEC = 120            # Single-call curation timeout — full-week prompt; Pro models are slower, give them room.
